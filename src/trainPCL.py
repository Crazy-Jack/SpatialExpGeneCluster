...
import pcl.loader
import network.pcl_builder as pcl_net
...
parser.add_argument('--dist-url', default='file:///mnt/nfs/sharedfile', type=str,
...
parser.add_argument('--multiprocessing-distributed', action='store_true',
                    help='Use multi-processing distributed training to launch '
                         ...
                         'fastest ways to use PyTorch for either single node or '
...
parser.add_argument('--exp-dir', default='../train_related/experiment_pcl/', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #     traindir,
    #     eval_augmentation)
    # TODO: define train dataset
    print("dataset ----------- ")
    train_dataset, eval_dataset = set_dataloader(args)
    if args.distributed:
